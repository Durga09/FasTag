...
//        binding.scannedKtNumber.setText("652210-108-1034068")
        ...
        binding.getTagList.setOnClickListener {
            ...
            if (registerVehicleNumber != "") {
                ...
                vehicleRegviewModel.getTagList(AppConstants.tenant,AppConstants.authorization, jsonData)
            }
        }
...
//        CallVehicleRegistration()
        ...
        if(SelectAddReplace==getString(R.string.Add_kit)) {
            ...
            if(oldKitNumber==""){
                ...
                val jsonData = Gson().toJson(unlockData)
                vehicleRegviewModel.tagClosure(AppConstants.tenant,AppConstants.authorization,jsonData)
            }
        }
    }
    ...
    private fun updateCustomerdetails(isAdditionalVehicle:Boolean){
        ...
        var requestData= UpdateCustomerRequestJson(agentId,personalDetailsData.firstName,
            personalDetailsData.emailAddress,AppConstants.phoneNumber,personalDetailsData.gender,personalDetailsData.pincode,personalDetailsData.state,AppConstants.country,AppConstants.entityType,AppConstants.entityId,
            ...
            "0000777",AppConstants.kycStatus,kit_number,kit_number,vehicleNumberVal,"0","0","Approved",personalDetailsData.customerId,isAdditionalVehicle)
