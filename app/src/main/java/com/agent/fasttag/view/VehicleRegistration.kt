...
class VehicleRegistration : AppCompatActivity() {
    ...
    private fun initView(){
        ...
        binding.etVehicleClassInput.setText(getString(R.string.TRUCK_CORPORATE))
        binding.etPhoneNumberInput.setText("2233445566")
...
//            println("vehicleClass:: $vehicleClass")
            ...
            var requestData= CustomerDetailsByIdReequest("91$phoneNumber")
